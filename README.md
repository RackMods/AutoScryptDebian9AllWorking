...
<p align="center">AutoScriptVPS is made by AcaVPN to minimize the time consumed and user involvement in setting up your VPS <b>with blocking the users to use torrents</b></p>
...
<p align="center">
<b>apt update && apt-get -y install git && git clone https://github.com/RackMods/AutoScryptDebian9AllWorking && cd AutoScryptDebian9AllWorking && chmod +x openvpn.sh && ./openvpn.sh</b>
</p>
